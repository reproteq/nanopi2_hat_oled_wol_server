    ...
    <div class="container">
    	<form class="form-signin" method="post">
			...
			<?php
                                ...
                                {
                                          if (( $_POST['password'] == 'passw') && ( $_POST['UserName'] == 'username') )
            ...
            <?php
					...
					while ($count <= $MAX_PINGS && $down == true)
					{
						...
						if ($pinginfo != "")
						{
							...
							echo "<span style='color:#00CC00;'><b>It's Alive!</b></span><br />";
                                                      ...
                                                      //   exec = ssh  root@n -p port sudo  poweroff
                ...
                {
            ?>
                    <input type="text" autocomplete=off class="input-block-level" placeholder="User Name" name="UserName">
        			<input type="password" autocomplete=off class="input-block-level" placeholder="Password" name="password">
